...
const Blog = () => {
  return (
    <div className="adv3__blog section__padding" id="tokenomics">
        <div className="adv3__blog-heading">
          <h1 className="gradient__text">Reimagining an Open World of Gaming.</h1>
        </div>
        <div className="adv3__blog-container">
          <div className="adv3__blog-container_groupA">
          ...
          <div className="adv3__blog-container_groupB">

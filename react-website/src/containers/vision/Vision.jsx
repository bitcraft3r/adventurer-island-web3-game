...
const Vision = () => {
  return (
    <div>
        <div className="adv3__vision section__margin" id="vision">
          <div className="adv3__vision-feature">
          ...
          <div className="adv3__vision-heading">
          ...
          <div className="adv3__vision-container">
